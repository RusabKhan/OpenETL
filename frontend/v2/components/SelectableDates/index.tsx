...
const SelectableDates: React.FC<SelectableDatesInterface> = (params) => {
  ...
  return (
    <div className="pb-4">
      ...
      {/* Container */}
      <div className="flex flex-wrap items-center gap-2 rounded-md border p-2 dark:bg-secondary">
        {selectedDates.map((date) => (
          <div
            key={date}
            className="flex items-center space-x-2 rounded-md bg-gray-700 px-3 py-1 text-white"
          >
        ...
        <input
          ...
          className="flex-1 border-none bg-whiten p-1 text-black dark:text-gray-200 focus:outline-none dark:bg-secondary"
        />
      </div>
