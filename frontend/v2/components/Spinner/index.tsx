...
const Spinner: React.FC<SpinnerToastProps> = ({
  ...
  return (
    <div className="fixed bottom-4 right-4 md:right-6 flex items-center space-x-4 rounded-lg bg-gray-800 px-6 py-3 text-white shadow-lg dark:bg-white dark:text-black">
